...
This document provides **test vectors** for the v1.0.0 Temporal operator family.
...
Guards are total predicates in v1.0.0: non-Text inputs and parse failures yield `Valid(false)`.
