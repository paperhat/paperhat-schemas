...
This document provides **test vectors** for the v1.0.0 Text operator family.
...
| `"abc"` | `"^a"` | `Valid(true)` |
| `"abc"` | `"^b"` | `Valid(false)` |
| `"abc"` | `"("` | `Invalid(["MatchesPattern::INVALID_PATTERN"])` |
| `"abc"` | `Integer(1)` | `Valid(false)` |

### 6.2 `DoesNotMatchPattern`

| Value | Pattern | Expected |
| --- | --- | --- |
| `"abc"` | `"^b"` | `Valid(true)` |
| `"abc"` | `"("` | `Invalid(["DoesNotMatchPattern::INVALID_PATTERN"])` |

---

**End of Text Conformance Appendix v1.0.0**
