...
| version | $Text | no | Version identifier (supports semver, edition numbers, etc.). |
| language | $EnumeratedToken | no | Content language, e.g. `$en`, `$fr`, `$zh`. Consuming schemas may constrain via a vocabulary. |
